...
public class HomebankingApplication {
    ...
    public CommandLineRunner init(ClientRepository ClientRepository,
        ...
        return args -> {
            ...
            Client cliente2 = new Client("Bronco", "Broncudo", "caballo.loco@bronco.com", passwordEncoder.encode("224"));
            ...
            //crear una cuenta
            Account cuenta1 = new Account("VIN-001", LocalDate.now().minusDays(1), 5000.00);
            ...
            Card card1 = new Card(cliente1.toString(), CardType.DEBIT, CardColor.GOLD, "1234567890", 322, LocalDate.now().minusYears(1), LocalDate.now().plusYears(4));
            Card card2 = new Card(cliente1.toString(), CardType.CREDIT, CardColor.TITANIUM, "9876543210", 101, LocalDate.now().minusYears(1), LocalDate.now().plusYears(4));
            Card card3 = new Card(cliente2.toString(), CardType.CREDIT, CardColor.SILVER, "4321876509", 666, LocalDate.now(), LocalDate.now().plusYears(2));
